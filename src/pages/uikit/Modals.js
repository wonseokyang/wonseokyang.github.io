            ...
            <Card>
                <CardBody>
                    ...
                    <div className="button-list">
                        ...
                        <Button color="secondary" onClick={() => this.openModalWithClass('modal-dialog-scrollable')}>
                            Scrollable Modal
                        </Button>
                    </div>

                    <h4 className="header-title mt-4">Modal Position</h4>
        ...
        return (
            <Card>
                <CardBody>
                    ...
                    <h4 className="header-title mt-4">Filled Modals</h4>
