                        ...
                        <React.Fragment>
                            ...
                            <Row>
                                <Col>
                                    ...
                                    <PaginationTotalStandalone {...paginationProps} dataSize={ordersReturn.length} />
                                </Col>
...
const Orders = () => {
    ...
    return (
        <React.Fragment>
            <PageTitle
                breadCrumbItems={[
                    { label: 'Report', path: '/report/ordersReturned' },
                    { label: 'Orders Returned', path: '/report/ordersReturned', active: true },
                ]}
            ...
            <Row>
                <Col>
                    <Card>
                        <CardBody>
                            <OrderTable data={ordersReturn} columns={columns} paginationOptions={paginationOptions} />
                        </CardBody>
                    </Card>
                </Col>
            </Row>
